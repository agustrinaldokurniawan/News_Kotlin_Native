    ...
    public void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
        ...
        if (event == Lifecycle.Event.upTo(this.$state$inlined)) {
            ...
            try {
                ...
                obj = Result.m34constructorimpl(function0.invoke());
            } catch (Throwable th) {
            ...
            this.$co.resumeWith(Result.m34constructorimpl(ResultKt.createFailure(new LifecycleDestroyedException())));
        }
    }
}
