...
public final class CoroutineLiveData<T> extends MediatorLiveData<T> {
    ...
    public CoroutineLiveData(CoroutineContext coroutineContext, long j, Function2<? super LiveDataScope<T>, ? super Continuation<? super Unit>, ? extends Object> function2) {
        ...
        this.blockRunner = new BlockRunner<>(this, function2, j, CoroutineScopeKt.CoroutineScope(Dispatchers.getMain().getImmediate().plus(coroutineContext).plus(SupervisorKt.SupervisorJob((Job) coroutineContext.get(Job.Key)))), new Function0<Unit>(this) {
            /* class androidx.lifecycle.CoroutineLiveData.AnonymousClass1 */
