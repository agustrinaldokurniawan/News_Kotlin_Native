    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                androidx.constraintlayout.solver.state.helpers.VerticalChainReference.AnonymousClass1.$SwitchMap$androidx$constraintlayout$solver$state$State$Chain = r0
            ...
            L_0x0012:
                int[] r0 = androidx.constraintlayout.solver.state.helpers.VerticalChainReference.AnonymousClass1.$SwitchMap$androidx$constraintlayout$solver$state$State$Chain     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = androidx.constraintlayout.solver.state.helpers.VerticalChainReference.AnonymousClass1.$SwitchMap$androidx$constraintlayout$solver$state$State$Chain     // Catch:{ NoSuchFieldError -> 0x0028 }
