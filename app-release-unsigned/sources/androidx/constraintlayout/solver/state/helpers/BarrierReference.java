    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                androidx.constraintlayout.solver.state.helpers.BarrierReference.AnonymousClass1.$SwitchMap$androidx$constraintlayout$solver$state$State$Direction = r0
            ...
            L_0x0012:
                int[] r0 = androidx.constraintlayout.solver.state.helpers.BarrierReference.AnonymousClass1.$SwitchMap$androidx$constraintlayout$solver$state$State$Direction     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = androidx.constraintlayout.solver.state.helpers.BarrierReference.AnonymousClass1.$SwitchMap$androidx$constraintlayout$solver$state$State$Direction     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = androidx.constraintlayout.solver.state.helpers.BarrierReference.AnonymousClass1.$SwitchMap$androidx$constraintlayout$solver$state$State$Direction     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = androidx.constraintlayout.solver.state.helpers.BarrierReference.AnonymousClass1.$SwitchMap$androidx$constraintlayout$solver$state$State$Direction     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = androidx.constraintlayout.solver.state.helpers.BarrierReference.AnonymousClass1.$SwitchMap$androidx$constraintlayout$solver$state$State$Direction     // Catch:{ NoSuchFieldError -> 0x0049 }
