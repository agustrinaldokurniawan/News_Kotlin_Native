...
public abstract class NavType<T> {
    ...
    static androidx.navigation.NavType inferFromValue(java.lang.String r1) {
        /*
            androidx.navigation.NavType<java.lang.Integer> r0 = androidx.navigation.NavType.IntType     // Catch:{ IllegalArgumentException -> 0x0006 }
            r0.parseValue(r1)     // Catch:{ IllegalArgumentException -> 0x0006 }
            return r0
        L_0x0006:
            androidx.navigation.NavType<java.lang.Long> r0 = androidx.navigation.NavType.LongType     // Catch:{ IllegalArgumentException -> 0x000c }
            r0.parseValue(r1)     // Catch:{ IllegalArgumentException -> 0x000c }
            return r0
        L_0x000c:
            androidx.navigation.NavType<java.lang.Float> r0 = androidx.navigation.NavType.FloatType     // Catch:{ IllegalArgumentException -> 0x0012 }
            r0.parseValue(r1)     // Catch:{ IllegalArgumentException -> 0x0012 }
            return r0
        L_0x0012:
            androidx.navigation.NavType<java.lang.Boolean> r0 = androidx.navigation.NavType.BoolType     // Catch:{ IllegalArgumentException -> 0x0018 }
