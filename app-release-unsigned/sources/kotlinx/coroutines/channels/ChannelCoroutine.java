...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    static /* synthetic */ Object m1426receiveOrClosedZYPwvRU$suspendImpl(ChannelCoroutine channelCoroutine, Continuation continuation) {
        return channelCoroutine._channel.m1428receiveOrClosedZYPwvRU(continuation);
    }
    ...
    public Object m1427receiveOrClosedZYPwvRU(Continuation<? super ValueOrClosed<? extends E>> continuation) {
        return m1426receiveOrClosedZYPwvRU$suspendImpl(this, continuation);
    }
