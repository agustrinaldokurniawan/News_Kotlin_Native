...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    private final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e, Closed<?> closed) {
        ...
        if (function1 == null || (callUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) == null) {
            ...
            continuation.resumeWith(Result.m34constructorimpl(ResultKt.createFailure(sendException)));
            return;
        }
        UndeliveredElementException undeliveredElementException = callUndeliveredElementCatchingException$default;
        ExceptionsKt.addSuppressed(undeliveredElementException, sendException);
        Result.Companion companion2 = Result.Companion;
        continuation.resumeWith(Result.m34constructorimpl(ResultKt.createFailure(undeliveredElementException)));
    }
    ...
    private final void helpClose(Closed<?> closed) {
        Object r2 = InlineList.m1452constructorimpl$default(null, 1, null);
        while (true) {
            ...
            if (receive == null) {
                ...
                r2 = InlineList.m1457plusUZ7vuAc(r2, receive);
            }
        }
        if (r2 != null) {
