...
public final class FlowKt {
    ...
    public static final <T> Flow<T> m1442catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return FlowKt__ErrorsKt.m1447catch(flow, function3);
    }
    ...
    public static final <T> Flow<T> m1443debounce8GFy2Ro(Flow<? extends T> flow, double d) {
        return FlowKt__DelayKt.m1445debounce8GFy2Ro(flow, d);
    }
    ...
    public static final <T> Flow<T> m1444sample8GFy2Ro(Flow<? extends T> flow, double d) {
        return FlowKt__DelayKt.m1446sample8GFy2Ro(flow, d);
    }
