...
public final class SharingStartedKt {
    ...
    public static /* synthetic */ SharingStarted m1449WhileSubscribed9tZugJw$default(SharingStarted.Companion companion, double d, double d2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m1448WhileSubscribed9tZugJw(companion, d, d2);
    }

    /* renamed from: WhileSubscribed-9tZugJw  reason: not valid java name */
    public static final SharingStarted m1448WhileSubscribed9tZugJw(SharingStarted.Companion companion, double d, double d2) {
