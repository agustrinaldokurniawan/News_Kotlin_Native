...
public final class SharedFlowImpl<T> extends AbstractSharedFlow<SharedFlowSlot> implements MutableSharedFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:20:0x0049 */
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:18:0x004c */
    /* JADX DEBUG: Multi-variable search result rejected for r11v4, resolved type: kotlin.coroutines.Continuation<kotlin.Unit>[] */
    /* JADX WARN: Multi-variable type inference failed */
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private final Continuation<Unit>[] findSlotsToResumeLocked(Continuation<Unit>[] continuationArr) {
        AbstractSharedFlowSlot[] abstractSharedFlowSlotArr;
    ...
    public final /* synthetic */ Object emitSuspend(T t, Continuation<? super Unit> continuation) {
        ...
        synchronized (this) {
            if (tryEmitLocked(t)) {
                Unit unit = Unit.INSTANCE;
                Result.Companion companion = Result.Companion;
                cancellableContinuationImpl2.resumeWith(Result.m34constructorimpl(unit));
        ...
        for (Continuation<Unit> continuation2 : continuationArr) {
            if (continuation2 != null) {
                ...
                continuation2.resumeWith(Result.m34constructorimpl(unit2));
            }
        }
