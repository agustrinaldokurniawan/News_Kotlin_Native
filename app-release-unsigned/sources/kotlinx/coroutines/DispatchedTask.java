...
public abstract class DispatchedTask<T> extends Task {
    ...
    public final void run() {
        ...
        try {
            ...
            if (delegate$kotlinx_coroutines_core != null) {
                ...
                try {
                    ...
                    if (job != null && !job.isActive()) {
                        ...
                        continuation.resumeWith(Result.m34constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
                    } else {
                        T successfulResult$kotlinx_coroutines_core = getSuccessfulResult$kotlinx_coroutines_core(takeState$kotlinx_coroutines_core);
                        Result.Companion companion3 = Result.Companion;
                        continuation.resumeWith(Result.m34constructorimpl(successfulResult$kotlinx_coroutines_core));
                    }
                    ...
                    try {
                        ...
                        obj2 = Result.m34constructorimpl(Unit.INSTANCE);
                    } catch (Throwable th2) {
                        Result.Companion companion5 = Result.Companion;
                        obj2 = Result.m34constructorimpl(ResultKt.createFailure(th2));
                    }
                    handleFatalException$kotlinx_coroutines_core(th, Result.m37exceptionOrNullimpl(obj2));
                    return;
                } finally {
            ...
            obj = Result.m34constructorimpl(ResultKt.createFailure(th3));
        }
        handleFatalException$kotlinx_coroutines_core(th, Result.m37exceptionOrNullimpl(obj));
    }
