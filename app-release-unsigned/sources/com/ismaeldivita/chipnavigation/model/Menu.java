...
public final class Menu {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: com.ismaeldivita.chipnavigation.model.Menu */
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            return (obj instanceof Menu) && Intrinsics.areEqual(this.items, ((Menu) obj).items);
        }
        return true;
    }
