...
public final class MenuStyle {
    ...
    public MenuStyle(Context context, TypedArray typedArray) {
        ...
        Intrinsics.checkParameterIsNotNull(typedArray, "attr");
        Integer valueOf = Integer.valueOf(typedArray.getResourceId(R.styleable.ChipNavigationBar_cnb_textAppearance, -1));
        this.textAppearance = !(valueOf.intValue() > 0) ? null : valueOf;
        this.radius = typedArray.getDimension(R.styleable.ChipNavigationBar_cnb_radius, FloatCompanionObject.INSTANCE.getMAX_VALUE());
        this.badgeColor = typedArray.getColor(R.styleable.ChipNavigationBar_cnb_badgeColor, ContextCompat.getColor(context, R.color.cnb_default_badge_color));
        this.unselectedColor = typedArray.getColor(R.styleable.ChipNavigationBar_cnb_unselectedColor, ContextCompat.getColor(context, R.color.cnb_default_unselected_color));
        this.iconSize = (int) typedArray.getDimension(R.styleable.ChipNavigationBar_cnb_iconSize, context.getResources().getDimension(R.dimen.cnb_icon_size));
    }
