...
public final class VerticalMenuItemView$cornerAnimation$$inlined$apply$lambda$1 implements ValueAnimator.AnimatorUpdateListener {
    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        if (animatedValue != null) {
            ...
            this.$this_cornerAnimation$inlined.setCornerRadii(this.$this_cornerAnimation$inlined.getLayoutDirection() == 0 ? new float[]{floatValue, floatValue, this.this$0.radius, this.this$0.radius, this.this$0.radius, this.this$0.radius, floatValue, floatValue} : new float[]{this.this$0.radius, this.this$0.radius, floatValue, floatValue, floatValue, floatValue, this.this$0.radius, this.this$0.radius});
            return;
        }
