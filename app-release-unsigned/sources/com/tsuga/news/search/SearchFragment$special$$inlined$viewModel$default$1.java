...
public final class SearchFragment$special$$inlined$viewModel$default$1 extends Lambda implements Function0<ViewModelOwner> {
    final /* synthetic */ Fragment $this_viewModel;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SearchFragment$special$$inlined$viewModel$default$1(Fragment fragment) {
        super(0);
