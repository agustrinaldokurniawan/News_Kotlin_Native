...
public final class ActivityExtKt$viewModel$2 extends Lambda implements Function0<T> {
    ...
    public ActivityExtKt$viewModel$2(ComponentActivity componentActivity, Qualifier qualifier, Function0<Bundle> function0, Function0<ViewModelOwner> function02, Function0<? extends DefinitionParameters> function03) {
        super(0);
    ...
    public final T invoke() {
        ...
        return (T) ActivityExtKt.getViewModel(componentActivity, qualifier, function0, function02, Reflection.getOrCreateKotlinClass(ViewModel.class), function03);
    }
}
