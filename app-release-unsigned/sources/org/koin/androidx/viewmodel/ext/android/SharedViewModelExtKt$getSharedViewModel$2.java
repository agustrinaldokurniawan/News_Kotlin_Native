...
final class SharedViewModelExtKt$getSharedViewModel$2 extends Lambda implements Function0<ViewModelOwner> {
    final /* synthetic */ Fragment $this_getSharedViewModel;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SharedViewModelExtKt$getSharedViewModel$2(Fragment fragment) {
        super(0);
