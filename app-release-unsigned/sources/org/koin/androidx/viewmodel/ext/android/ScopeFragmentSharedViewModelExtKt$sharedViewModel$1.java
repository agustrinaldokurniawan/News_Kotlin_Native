...
public final class ScopeFragmentSharedViewModelExtKt$sharedViewModel$1 extends Lambda implements Function0<ViewModelOwner> {
    final /* synthetic */ ScopeFragment $this_sharedViewModel;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ScopeFragmentSharedViewModelExtKt$sharedViewModel$1(ScopeFragment scopeFragment) {
        super(0);
