...
final class ScopedActivityExtKt$viewModel$3 extends Lambda implements Function0<ViewModelOwner> {
    final /* synthetic */ ScopeActivity $this_viewModel;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ScopedActivityExtKt$viewModel$3(ScopeActivity scopeActivity) {
        super(0);
