...
final class ScopedActivityExtKt$getViewModel$2 extends Lambda implements Function0<ViewModelOwner> {
    final /* synthetic */ ScopeActivity $this_getViewModel;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ScopedActivityExtKt$getViewModel$2(ScopeActivity scopeActivity) {
        super(0);
