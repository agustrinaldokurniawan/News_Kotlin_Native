...
public final class FragmentExtKt$getViewModel$1 extends Lambda implements Function0<ViewModelOwner> {
    final /* synthetic */ Fragment $this_getViewModel;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public FragmentExtKt$getViewModel$1(Fragment fragment) {
        super(0);
