...
final class ScopeFragmentExtKt$viewModel$3 extends Lambda implements Function0<ViewModelOwner> {
    final /* synthetic */ ScopeFragment $this_viewModel;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ScopeFragmentExtKt$viewModel$3(ScopeFragment scopeFragment) {
        super(0);
