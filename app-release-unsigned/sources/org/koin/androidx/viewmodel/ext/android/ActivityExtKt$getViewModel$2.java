...
final class ActivityExtKt$getViewModel$2 extends Lambda implements Function0<ViewModelOwner> {
    final /* synthetic */ ComponentActivity $this_getViewModel;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ActivityExtKt$getViewModel$2(ComponentActivity componentActivity) {
        super(0);
