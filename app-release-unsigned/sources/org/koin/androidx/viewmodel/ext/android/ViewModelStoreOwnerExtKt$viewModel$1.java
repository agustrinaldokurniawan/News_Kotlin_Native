...
public final class ViewModelStoreOwnerExtKt$viewModel$1 extends Lambda implements Function0<T> {
    ...
    public ViewModelStoreOwnerExtKt$viewModel$1(ViewModelStoreOwner viewModelStoreOwner, Qualifier qualifier, Function0<Bundle> function0, Function0<? extends DefinitionParameters> function02) {
        super(0);
    ...
    public final T invoke() {
        ...
        return (T) ViewModelStoreOwnerExtKt.getViewModel(viewModelStoreOwner, qualifier, function0, Reflection.getOrCreateKotlinClass(ViewModel.class), function02);
    }
}
