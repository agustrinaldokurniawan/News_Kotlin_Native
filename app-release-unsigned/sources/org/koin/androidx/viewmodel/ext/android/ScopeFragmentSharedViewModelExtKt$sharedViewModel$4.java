...
final class ScopeFragmentSharedViewModelExtKt$sharedViewModel$4 extends Lambda implements Function0<T> {
    ...
    ScopeFragmentSharedViewModelExtKt$sharedViewModel$4(ScopeFragment scopeFragment, Qualifier qualifier, Function0<Bundle> function0, Function0<ViewModelOwner> function02, KClass<T> kClass, Function0<? extends DefinitionParameters> function03) {
        super(0);
    ...
    public final T invoke() {
        return (T) ScopeFragmentExtKt.getViewModel(this.$this_sharedViewModel, this.$qualifier, this.$state, this.$owner, this.$clazz, this.$parameters);
    }
}
