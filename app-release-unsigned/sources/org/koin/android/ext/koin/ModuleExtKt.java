...
public final class ModuleExtKt {
    ...
    public static final Context androidContext(Scope scope) {
        ...
        try {
            return (Context) scope.get(Reflection.getOrCreateKotlinClass(Context.class), (Qualifier) null, (Function0<? extends DefinitionParameters>) null);
    ...
    public static final Application androidApplication(Scope scope) {
        Intrinsics.checkNotNullParameter(scope, "<this>");
        try {
            return (Application) scope.get(Reflection.getOrCreateKotlinClass(Application.class), (Qualifier) null, (Function0<? extends DefinitionParameters>) null);
        } catch (Exception unused) {
