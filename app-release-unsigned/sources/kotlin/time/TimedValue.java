...
public final class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1415copyRFiDyg4$default(TimedValue timedValue, Object obj, long j, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m1417copyRFiDyg4(obj, j);
    }
    ...
    public final long m1416component2UwyO8pc() {
        return this.duration;
    }

    /* renamed from: copy-RFiDyg4  reason: not valid java name */
    public final TimedValue<T> m1417copyRFiDyg4(T t, long j) {
    ...
    public String toString() {
        return "TimedValue(value=" + ((Object) this.value) + ", duration=" + Duration.m1378toStringimpl(this.duration) + ")";
    }
    ...
    public final long m1418getDurationUwyO8pc() {
        return this.duration;
    }
