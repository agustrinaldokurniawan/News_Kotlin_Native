...
public abstract class TimeMark {
    ...
    public abstract long m1412elapsedNowUwyO8pc();

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1414plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this, j, null);
    }

    /* renamed from: minus-LRDsOJo  reason: not valid java name */
    public TimeMark m1413minusLRDsOJo(long j) {
        return m1414plusLRDsOJo(Duration.m1381unaryMinusUwyO8pc(j));
    }

    public final boolean hasPassedNow() {
        return !Duration.m1361isNegativeimpl(m1412elapsedNowUwyO8pc());
    }
