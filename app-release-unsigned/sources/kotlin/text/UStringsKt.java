...
public final class UStringsKt {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m179unboximpl();
        if (UnsignedKt.uintCompare(r1, UInt.m128constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m46boximpl(UByte.m52constructorimpl((byte) r1));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m179unboximpl();
        if (UnsignedKt.uintCompare(r1, UInt.m128constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m306boximpl(UShort.m312constructorimpl((short) r1));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int r5 = UInt.m128constructorimpl(i);
        int i4 = 119304647;
        while (i3 < length) {
            ...
            if (UnsignedKt.uintCompare(i2, i4) > 0) {
                if (i4 == 119304647) {
                    i4 = UnsignedKt.m381uintDivideJ1ME1BU(-1, r5);
                    if (UnsignedKt.uintCompare(i2, i4) > 0) {
                    }
                }
                return null;
            }
            int r3 = UInt.m128constructorimpl(i2 * r5);
            int r8 = UInt.m128constructorimpl(UInt.m128constructorimpl(digitOf) + r3);
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long r9 = ULong.m206constructorimpl((long) i);
        long j2 = 0;
        ...
        while (i2 < length) {
            ...
            if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                if (j3 == 512409557603043100L) {
                    j3 = UnsignedKt.m383ulongDivideeb3DHEI(j, r9);
                    if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                    }
                }
                return null;
            }
            long r11 = ULong.m206constructorimpl(j2 * r9);
            long r4 = ULong.m206constructorimpl(ULong.m206constructorimpl(((long) UInt.m128constructorimpl(digitOf)) & 4294967295L) + r11);
