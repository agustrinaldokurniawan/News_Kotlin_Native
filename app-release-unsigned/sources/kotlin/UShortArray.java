...
public final class UShortArray implements Collection<UShort>, KMappedMarker {
    ...
    public static boolean m367equalsimpl(short[] sArr, Object obj) {
        return (obj instanceof UShortArray) && Intrinsics.areEqual(sArr, ((UShortArray) obj).m378unboximpl());
    }
    ...
    public boolean containsAll(Collection<? extends Object> collection) {
        return m366containsAllimpl(this.storage, collection);
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UShort) {
            return m377containsxj2QHRw(((UShort) obj).m361unboximpl());
        }
        return false;
    }
    ...
    public static final class Iterator extends UShortIterator {
        ...
        public short m379nextUShortMh2AYeg() {
            int i = this.index;
    ...
    public static boolean m366containsAllimpl(short[] sArr, Collection<UShort> collection) {
        boolean z;
        Intrinsics.checkNotNullParameter(collection, "elements");
        Collection<UShort> collection2 = collection;
        if (!collection2.isEmpty()) {
            for (T t : collection2) {
                if (!(t instanceof UShort) || !ArraysKt.contains(sArr, t.m361unboximpl())) {
                    z = false;
                    continue;
                } else {
                    z = true;
