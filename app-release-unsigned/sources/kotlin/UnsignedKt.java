...
public final class UnsignedKt {
    ...
    public static final int m381uintDivideJ1ME1BU(int i, int i2) {
        return UInt.m128constructorimpl((int) ((((long) i) & 4294967295L) / (((long) i2) & 4294967295L)));
    }
    ...
    public static final long m383ulongDivideeb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return ulongCompare(j, j2) < 0 ? ULong.m206constructorimpl(0) : ULong.m206constructorimpl(1);
        }
        if (j >= 0) {
            return ULong.m206constructorimpl(j / j2);
        }
        int i = 1;
        long j3 = ((j >>> 1) / j2) << 1;
        if (ulongCompare(ULong.m206constructorimpl(j - (j3 * j2)), ULong.m206constructorimpl(j2)) < 0) {
            i = 0;
        }
        return ULong.m206constructorimpl(j3 + ((long) i));
    }

    /* renamed from: ulongRemainder-eb3DHEI  reason: not valid java name */
    public static final long m384ulongRemaindereb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return ulongCompare(j, j2) < 0 ? j : ULong.m206constructorimpl(j - j2);
        }
        if (j >= 0) {
            return ULong.m206constructorimpl(j % j2);
        }
        long j3 = j - ((((j >>> 1) / j2) << 1) * j2);
        if (ulongCompare(ULong.m206constructorimpl(j3), ULong.m206constructorimpl(j2)) < 0) {
            j2 = 0;
        }
        return ULong.m206constructorimpl(j3 - j2);
    }
    ...
    public static final int doubleToUInt(double d) {
        ...
        if (d <= d2) {
            return UInt.m128constructorimpl((int) d);
        }
        return UInt.m128constructorimpl(UInt.m128constructorimpl((int) (d - d2)) + UInt.m128constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double d) {
        ...
        if (d < ((double) LongCompanionObject.MAX_VALUE)) {
            return ULong.m206constructorimpl((long) d);
        }
        return ULong.m206constructorimpl(ULong.m206constructorimpl((long) (d - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
