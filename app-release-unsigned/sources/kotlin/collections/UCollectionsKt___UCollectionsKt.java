...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> collection) {
        ...
        byte[] r0 = UByteArray.m103constructorimpl(collection.size());
        int i = 0;
        for (UByte uByte : collection) {
            UByteArray.m114setVurrAj0(r0, i, uByte.m101unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> collection) {
        ...
        int[] r0 = UIntArray.m181constructorimpl(collection.size());
        int i = 0;
        for (UInt uInt : collection) {
            UIntArray.m192setVXSXFK8(r0, i, uInt.m179unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final long[] toULongArray(Collection<ULong> collection) {
        ...
        long[] r0 = ULongArray.m259constructorimpl(collection.size());
        int i = 0;
        for (ULong uLong : collection) {
            ULongArray.m270setk8EXiF4(r0, i, uLong.m257unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> collection) {
        ...
        short[] r0 = UShortArray.m363constructorimpl(collection.size());
        int i = 0;
        for (UShort uShort : collection) {
            UShortArray.m374set01HTLdE(r0, i, uShort.m361unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int sumOfUInt(Iterable<UInt> iterable) {
        ...
        for (UInt uInt : iterable) {
            i = UInt.m128constructorimpl(i + uInt.m179unboximpl());
        }
        return i;
    }
    ...
    public static final long sumOfULong(Iterable<ULong> iterable) {
        ...
        for (ULong uLong : iterable) {
            j = ULong.m206constructorimpl(j + uLong.m257unboximpl());
        }
        return j;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> iterable) {
        ...
        for (UByte uByte : iterable) {
            i = UInt.m128constructorimpl(i + UInt.m128constructorimpl(uByte.m101unboximpl() & UByte.MAX_VALUE));
        }
        return i;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> iterable) {
        ...
        for (UShort uShort : iterable) {
            i = UInt.m128constructorimpl(i + UInt.m128constructorimpl(uShort.m361unboximpl() & UShort.MAX_VALUE));
        }
        return i;
    }
}
