                                                    ...
                                                    if (!(t instanceof UByteArray) || !(t2 instanceof UByteArray)) {
                                                        if (!(t instanceof UShortArray) || !(t2 instanceof UShortArray)) {
                                                            if (!(t instanceof UIntArray) || !(t2 instanceof UIntArray)) {
                                                                ...
                                                                } else if (!UArraysKt.m582contentEqualslec5QzE(t.m274unboximpl(), t2.m274unboximpl())) {
                                                                    return false;
                                                                }
                                                            } else if (!UArraysKt.m578contentEqualsKJPZfPQ(t.m196unboximpl(), t2.m196unboximpl())) {
                                                                return false;
                                                            }
                                                        } else if (!UArraysKt.m577contentEqualsFGO6Aew(t.m378unboximpl(), t2.m378unboximpl())) {
                                                            return false;
                                                        }
                                                    } else if (!UArraysKt.m580contentEqualskV0jMPg(t.m118unboximpl(), t2.m118unboximpl())) {
                                                        return false;
                                                    }
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                if (t instanceof UByteArray) {
                    T t2 = t;
                    if (t2 != null) {
                        bArr = t2.m118unboximpl();
                    }
                    sb.append(UArraysKt.m594contentToString2csIQuQ(bArr));
                } else if (t instanceof UShortArray) {
                    T t3 = t;
                    if (t3 != null) {
                        sArr = t3.m378unboximpl();
                    }
                    sb.append(UArraysKt.m598contentToStringd6D3K8(sArr));
                } else if (t instanceof UIntArray) {
                    T t4 = t;
                    if (t4 != null) {
                        iArr = t4.m196unboximpl();
                    }
                    sb.append(UArraysKt.m597contentToStringXUkPCBk(iArr));
                } else if (t instanceof ULongArray) {
                    T t5 = t;
                    if (t5 != null) {
                        jArr = t5.m274unboximpl();
                    }
                    sb.append(UArraysKt.m600contentToStringuLth9ew(jArr));
                } else {
