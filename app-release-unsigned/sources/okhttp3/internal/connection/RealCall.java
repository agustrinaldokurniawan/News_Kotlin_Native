...
public final class RealCall implements Call {
    ...
    public final class AsyncCall implements Runnable {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:17:0x005f A[Catch:{ IOException -> 0x0084, all -> 0x0054, all -> 0x0082 }] */
        /* JADX WARNING: Removed duplicated region for block: B:24:0x008a A[Catch:{ IOException -> 0x0084, all -> 0x0054, all -> 0x0082 }] */
        /* JADX WARNING: Removed duplicated region for block: B:25:0x00ae A[Catch:{ IOException -> 0x0084, all -> 0x0054, all -> 0x0082 }] */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void run() {
            /*
    ...
    private final <E extends IOException> E callDone(E e) {
        ...
        if (!Util.assertionsEnabled || !Thread.holdsLock(this)) {
            ...
            if (e != null) {
                ...
                eventListener2.callFailed(realCall, e2);
            } else {
